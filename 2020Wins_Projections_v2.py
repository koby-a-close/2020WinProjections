...
ranks = len(MLR_predictions_2019) + 1 - rankdata(MLR_predictions_2019)
log_2019 = np.log(ranks)
multiplier_2019 = abs(2430-sum(MLR_predictions_2019))/75
scaler_2019 = log_2019*multiplier_2019
scaled_wins_2019 = MLR_predictions_2019+scaler_2019

MLR_pred_2019 = pd.DataFrame()
MLR_pred_2019['Team'] = team_records.Team
MLR_pred_2019['Predicted Wins'] = scaled_wins_2019
MLR_pred_2019['Actual Wins'] = team_records.wins2019

ranks = len(MLR_predictions_2020) + 1 - rankdata(MLR_predictions_2020)
log_2020 = np.log(ranks)
multiplier_2020 = abs(2430-sum(MLR_predictions_2020))/75
scaler_2020 = log_2020*multiplier_2020
scaled_wins_2020 = MLR_predictions_2020-scaler_2020

MLR_pred_2020 = pd.DataFrame()
MLR_pred_2020['Team'] = team_records.Team
MLR_pred_2020['Predicted 2020 Wins'] = MLR_predictions_2020
MLR_pred_2020['Scaled 2020 Predicted Wins'] = scaled_wins_2020

print(sum(MLR_pred_2019['Predicted Wins']))
print(sum(MLR_pred_2020['Scaled 2020 Predicted Wins']))
